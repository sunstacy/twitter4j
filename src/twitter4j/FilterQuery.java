...
public final class FilterQuery implements java.io.Serializable {
     ...
     * Creates a new FilterQuery
     *
     * @param follow Specifies the language to receive public tweets from.
     * 		  But this program is deprecated because the twitter
     * 		  does not support filtering by languages
     * 		
     * @author danny 
     */
    public FilterQuery(int count, String[] lang) {
        this();
        this.count = 0;
        this.lang = lang;
    }
    ...
    /*package*/ HttpParameter[] asHttpParameterArray(HttpParameter stallWarningsParam) {
        ...
        {
        	params.add(new HttpParameter("lang"
                    , z_T4JInternalStringUtil.join(lang)));        	
        }
